<h1 class="invoice-not-final">THIS INVOICE IS NOT FINAL</h1>

<!-- JPMV3 CUSTOM INVOICE PAGE -->
	
    <!-- JPM DETAILS -->
	<p><b>
    	14035 Image Lake Ct.<br>
        Fort Myers, FL 33907<br>
    </b></p>
    
    <br>
    
    <h3 class="wpi_greeting"><?php echo sprintf(__('%s', WPI), recipients_name(array('return' => true))) ?></h3>
